...
class bmsMUST(bms, deviceModbus): #  object to communicate with and manage MUST battery
    ...
    def readData(self): # read inverter control message values
        bWarnings = {
            0x0001: "battery cell overvoltage alarm",
            0x0002: "battery cell low voltage alarm",
            0x0004: "battery pack overvoltage alarm",
            0x0008: "battery pack low voltage alarm",
            0x0010: "charging over current alarm",
            0x0020: "discharging over current alarm",
            0x0040: "Unknown Warning 6",
            0x0080: "Unknown Warning 7",
            0x0100: "charging high temperature alarm",
            0x0200: "discharging high temperature alarm",
            0x0400: "charging low temperature alarm",
            0x0800: "discharging low temperature alarm",
            0x1000: "environment high temperature alarm",
            0x2000: "environment low temperature alarm",
            0x4000: "MOSFET high temperature alarm",
            0x8000: "SOC Low alarm"
            }
        bProtections = {
            0x0001: "battery cell over voltage protection",
            0x0002: "battery cell low voltage protection",
            0x0004: "battery pack over voltage protection",
            0x0008: "battery pack low voltage protection",
            0x0010: "charging over current protection",
            0x0020: "discharging over current protection",
            0x0040: "short circuit protection",
            0x0080: "charger overvoltage protection",
            0x0100: "charging high temperature protection",
            0x0200: "discharging high temperature protection",
            0x0400: "charging low temperature protection",
            0x0800: "discharging low temperature protection",
        ...
        bFaults = {
            ...
            0x02: "discharging MOSFET fault",
            0x04: "temperature sensor fault",
            0x08: "unknown fault 3",
            0x10: "battery cell fault",
            0x20: "front end sampling communication fault",
